import{I,A,g}from"./index.js";import{C}from"./index-0gt3gf92.js";var n=32,p={damping:20,stiffness:200,type:"spring"};function f(s){s.innerHTML=A`<div class="flex size-full flex-col items-center justify-center gap-4 p-4">
  ...
  </div>`;let{cssBox:a,cssBall:l,springBox:i,springBall:o}=g(s),d=[];C(o,{x:80,y:48},{duration:0});function c(e,t){let r=e.getBoundingClientRect();return{x:t.clientX-r.left-n/2,y:t.clientY-r.top-n/2}}return a.addEventListener("click",(e)=>{let{x:t,y:r}=c(a,e);l.style.left=`${t}px`,l.style.top=`${r}px`}),i.addEventListener("click",(e)=>{let{x:t,y:r}=c(i,e);d.push(C(o,{x:t,y:r},p))}),{destroy(){for(let e of d)e.stop()}}}export{f as mount};
