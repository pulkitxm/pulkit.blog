import{p}from"./index-nwchbdm6.js";import{A,g}from"./index.js";function f(r){let e=!1,t=!1;r.innerHTML=A`<div class="flex size-full flex-col items-center justify-center gap-8 p-6">
  ...
  </div>`;let{marginColumn:s,transformColumn:l,marginBox:i,transformBox:o}=g(r),a=p({variant:"outline",size:"sm",label1:"Move with margin",label2:"Reset",onClick:()=>{e=!e,a.swapped=e,i.style.marginLeft=e?"80px":"0px"}}),n=p({variant:"outline",size:"sm",label1:"Move with transform",label2:"Reset",onClick:()=>{t=!t,n.swapped=t,o.style.transform=t?"translateX(112%)":"translateX(0)"}});s.append(a.element),l.append(n.element)}export{f as mount};
