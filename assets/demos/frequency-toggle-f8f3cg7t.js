import{A,g}from"./index.js";import{C}from"./index-0gt3gf92.js";var v=["Open File","Run Command","Search Symbol"];function k(i){let a=!0,l=!1,d=0,t=null,r=!1,n;i.innerHTML=A`<div class="flex size-full flex-col items-center justify-center gap-4 p-4">
    ...
    <div class="flex flex-col items-center gap-2">
  ...
  </div>`;let{placeholder:o,question:u}=g(i);function s(){return a?{duration:0.15,ease:[0.16,1,0.3,1]}:{duration:0}}function f(){let e=document.createElement("div");return e.className="absolute inset-x-0 top-10 mx-2 mt-2 rounded-md border border-neutral-300 bg-white p-2 shadow-lg dark:border-neutral-600 dark:bg-neutral-800",e.innerHTML=A`<input
        type="text"
        placeholder="Search..."
      ...
      </div>`,e}function m(){if(t&&r){r=!1,n?.stop(),n=C(t,{opacity:1,y:0},s());return}if(t=f(),o.before(t),a)C(t,{opacity:0,y:-8},{duration:0}),n=C(t,{opacity:1,y:0},s())}function x(){if(!t)return;let e=t;r=!0,n?.stop(),n=C(e,a?{opacity:0,y:-8}:{opacity:0},s()),n.then(()=>{if(t===e&&r)e.remove(),t=null,r=!1})}function c(e){if(a=e,l=!l,d+=1,o.hidden=l,l)m();else x();u.hidden=d<=5,u.textContent=`After ${d} toggles, which feels faster for repeated use?`}function p(e){if(e.key==="j"||e.key==="J")c(!0);else if(e.key==="k"||e.key==="K")c(!1)}return window.addEventListener("keydown",p),{destroy(){window.removeEventListener("keydown",p),n?.stop()}}}export{k as mount};
