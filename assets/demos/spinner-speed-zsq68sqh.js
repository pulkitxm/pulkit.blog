import{I}from"./index.js";var a=[{duration:"1.5s",feel:"Feels sluggish",label:"1.5s rotation"},{duration:"0.6s",feel:"Feels active",label:"0.6s rotation"}],l=(t)=>{t.innerHTML=I`<div class="flex size-full flex-col items-center justify-center gap-6 p-4">
    <p class="text-center text-neutral-600 text-sm dark:text-neutral-400">Same wait time, different perceived speed</p>
    <div class="flex items-center gap-12">
      ${a.map((e)=>I`<div class="flex flex-col items-center gap-3">
