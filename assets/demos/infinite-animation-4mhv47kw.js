import{I}from"./index.js";import{Q,o}from"./index-9xe00pb0.js";var s=`
  @keyframes spin {
...
`,n=(e)=>{e.innerHTML=Q("gap-8 p-6",I`
    ...
    <style>${s}</style>
    ${o("Infinite CSS animations run on the GPU. They never touch the main thread, so they stay smooth forever without draining batteries.",{width:"max-w-sm"})}
  `)};export{n as mount};
