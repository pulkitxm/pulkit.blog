import{m}from"./index-td2556c3.js";import{A,I}from"./index.js";var d=(e)=>{e.innerHTML=I`<div class="flex size-full flex-col items-center justify-center gap-6 p-6">
  ...
  </div>`;let r=A(e,"small",HTMLDivElement),s=A(e,"large",HTMLDivElement),t=m({variant:"outline",size:"sm",label1:"Apply translateY(100%)",label2:"Reset",onClick:()=>{t.swapped=!t.swapped;let a=t.swapped?"translateY(100%)":"translateY(0)";r.style.transform=a,s.style.transform=a}});A(e,"slot",HTMLDivElement).replaceWith(t.element)};export{d as mount};
