import{A,I}from"./index.js";var u=(s)=>{let t={x:0,y:0},n=!1;s.innerHTML=I`<div class="flex size-full flex-col items-center justify-center gap-6 p-6">
  ...
  </div>`;let e=A(s,"card",HTMLDivElement),d=A(s,"xLabel",HTMLSpanElement),c=A(s,"yLabel",HTMLSpanElement);function r(){e.style.transform=`rotateX(${t.x}deg) rotateY(${t.y}deg)`,e.style.transformStyle="preserve-3d",e.style.transition=n?"transform 0.1s ease-out":"transform 0.3s ease-out",d.textContent=`rotateX: ${t.x.toFixed(1)}°`,c.textContent=`rotateY: ${t.y.toFixed(1)}°`}e.addEventListener("mousemove",(o)=>{let a=e.getBoundingClientRect(),x=o.clientX-a.left,m=o.clientY-a.top,l=a.width/2,i=a.height/2;t={x:(m-i)/i*-15,y:(x-l)/l*15},r()}),e.addEventListener("mouseleave",()=>{t={x:0,y:0},n=!1,r()}),e.addEventListener("mouseenter",()=>{n=!0,r()}),r()};export{u as mount};
