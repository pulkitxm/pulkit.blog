import{A,g}from"./index.js";var s=700,n=300;function x(t){return["translateX(0) rotate(0deg)","translateX(60px) rotate(0deg)"][t]??"translateX(60px) rotate(45deg)"}function f(t){return["translateX(0) rotate(0deg)","translateX(0) rotate(45deg)"][t]??"rotate(45deg) translateX(60px)"}function l(){return'<div class="absolute inset-0 flex items-center justify-center"><div class="h-px w-full bg-neutral-300 dark:bg-neutral-700"></div></div><div class="absolute inset-0 flex items-center justify-center"><div class="h-full w-px bg-neutral-300 dark:bg-neutral-700"></div></div>'}function m(t){t.innerHTML=A`<div class="flex size-full flex-col items-center justify-center gap-6 p-6">
  ...
  </div>`;let{a:i,b:o}=g(t);function e(r){for(let[a,u]of[[i,x(r)],[o,f(r)]])a.style.transform=u,a.style.transformOrigin="center center",a.style.transitionDuration=`${s}ms`}e(0);let d=setTimeout(()=>e(1),n),c=setTimeout(()=>e(2),n+s);return{destroy(){clearTimeout(d),clearTimeout(c)}}}export{m as mount};
