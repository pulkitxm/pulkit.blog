import{I}from"./index.js";var s="animation: demo-shimmer 1.5s ease-in-out infinite; background: linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.4) 50%, transparent 100%)";function e(t){return I`<div class="relative overflow-hidden rounded" style="height: 12px; width: ${t}">
    <div class="absolute inset-0 bg-neutral-200 dark:bg-neutral-700"></div>
    <div class="absolute inset-0" style="${s}"></div>
  </div>`}var a=(t)=>{t.innerHTML=I`<div class="flex size-full flex-col items-center justify-center gap-6 p-6">
