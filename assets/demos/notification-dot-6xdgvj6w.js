import{t,I}from"./index.js";import{Q}from"./index-9xe00pb0.js";var e=[["path",{d:"M10.268 21a2 2 0 0 0 3.464 0"}],["path",{d:"M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326"}]];var r=`
  @keyframes pulse-bad {
    0%, 100% {
      width: 10px;
      height: 10px;
...
`,a=()=>t(e,"size-6 text-neutral-600 dark:text-neutral-300"),o=(s)=>{s.innerHTML=Q("gap-8 p-6",I`
    ...
    <div class="flex flex-wrap items-center justify-center gap-16">
      <div class="flex flex-col items-center gap-4">
        <div class="relative">
          <div class="flex size-12 items-center justify-center rounded-lg bg-neutral-100 dark:bg-neutral-800">${a()}</div>
