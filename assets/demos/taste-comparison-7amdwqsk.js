import{I,A}from"./index.js";var t="bg-neutral-800 text-white hover:bg-neutral-700 dark:bg-neutral-200 dark:text-neutral-900 dark:hover:bg-neutral-300";function s(e){e.innerHTML=A`<div class="flex size-full flex-col items-center justify-center gap-8 p-6">
    <div class="flex flex-wrap justify-center gap-12">
      <div class="flex flex-col items-center gap-4">
        <p class="font-medium text-neutral-900 text-sm dark:text-neutral-100">With Taste</p>
        ${I({className:t,label:"Subscribe",attrs:'style="transition: transform 200ms cubic-bezier(0.34, 1.56, 0.64, 1)"'})}
      ...
      <div class="flex flex-col items-center gap-4">
        ...
        ${I({className:t,label:"Subscribe",attrs:'style="transition: transform 200ms linear"'})}
