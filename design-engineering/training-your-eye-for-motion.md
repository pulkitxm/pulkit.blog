...
- URL: https://pulkit.blog/design-engineering/training-your-eye-for-motion/
- Published: January 29, 2026
- Tags: Animation, UX, Taste, Design Engineering
...
**Interactive demo: Taste comparison.** [Try it on the page](https://pulkit.blog/design-engineering/training-your-eye-for-motion/).
...
[Raycast](https://raycast.com) doesn't win because it has more features than Spotlight. It wins because using it feels different. [Figma](https://figma.com) didn't take over design because Sketch couldn't do the same things. It won because every interaction felt more considered.
...
[Raycast](https://raycast.com). Things 3. Craft. Cron (now Notion Calendar). Amie. Bear. Use these products slowly. Notice the animations. They've spent enormous effort on details most people never see.
...
[Radix](https://www.radix-ui.com). [Shadcn](https://ui.shadcn.com). [Sonner](https://sonner.emilkowal.ski). [Vaul](https://vaul.emilkowal.ski). These aren't just component libraries. They encode decisions about timing, easing, and interaction patterns that you can learn from by reading the source.
...
[This series](https://pulkit.blog/design-engineering.md) covers a lot of rules. Ease-out for entrances. Ease-in for exits. 200ms as a baseline duration. Spring physics for interactive elements.
